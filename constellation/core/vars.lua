...
vars.add = function(var_name)end
...
---@return number|string|boolean The value of the FantasyVar.
---@type fun(var_name: string): number|string|boolean
vars.get = function(var_name)end
...
---```
---@return number,number,number The red, green, and blue values of the color.
...
vars.menu = function(label, fantasyvar, html_code, value)end